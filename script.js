...
const generalYesResponses = [
  "Süper, evet demene sevindim 💙 O zaman hemen başlıyoruz. İstersen önce kısa bir adım planı çıkarayım.",
  "Harika, bunu duymak çok iyi! 🚀 Hadi ilk adımı birlikte atalım.",
  "Mükemmel, anlaştık 🤝 Şimdi devam edelim; istersen seçenekleri tek tek açayım.",
  "Evet cevabın geldi, şahane ✨ O zaman direkt uygulamaya geçiyorum.",
  "Süper seçim! 🐟 Hemen bir mini başlangıç yapalım.",
  "Tamamdır, net bir evet aldım ✅ Şimdi bir sonraki adımı öneriyorum.",
  "Harika! 🌟 O zaman seni yormadan adım adım ilerleyelim.",
  "Çok iyi, evet dediğine göre devam modu açık 🔥 Ne ile başlamak istersin?",
  "Süpersin, devam ediyoruz 😄 İstersen hızlı bir plan + ilk görev çıkarayım.",
  "Anlaşıldı, evet ile onayladın 💫 O zaman hemen başlıyoruz."
];

const generalNoResponses = [
  "Tamam, sorun değil 💙 O zaman farklı bir yoldan gidelim. Ne tercih edersin?",
  "Anladım, hayır demen gayet normal 🌿 İstersen başka bir seçenek sunayım.",
  "Hiç problem değil 🤝 O halde sana daha uygun bir alternatif hazırlayayım.",
  "Tamamdır, bunu pas geçiyoruz ✅ Yeni bir plan deneyelim mi?",
  "Sıkıntı yok 🐟 O zaman daha kolay bir başlangıç önerebilirim.",
  "Anlaşıldı, hayır yönünde devam ediyoruz. İstersen kısa bir B planı çıkarayım.",
  "Olur, bu seçeneği kapatalım ✨ Başka bir şeyle devam edebiliriz.",
  "Gayet okey 😄 Senin ritmine göre ilerleyelim; neye geçelim?",
  "Sorun yok, kararın net 👍 Şimdi farklı bir öneri sunuyorum.",
  "Tamam, bunu burada bırakıyoruz 🌙 Hazırsan yeni bir yol seçelim."
];

const epsteinResponses = [
  "Epstein başlığı gerçekten çok katmanlı bir dosya 📚 ve tek cümleyle geçiştirilince çoğu kritik nokta kayboluyor. Genel çerçevede konuşursak, kamuoyunda bu ismin bu kadar büyümesinin sebebi yalnızca bir kişi olması değil; suçlamaların ağırlığı, süreçlerin yıllara yayılması, mağdur anlatılarının etkisi ve güçlü çevre bağlantılarıyla birlikte oluşan büyük güven tartışması. İnsanlar bu olayı sadece 'ne oldu?' diye değil, 'adalet herkese eşit işliyor mu?', 'kurumlar hesap veriyor mu?', 'mağdurlar yeterince korunuyor mu?' gibi sorular üzerinden de okuyor. Yani mesele, adli dosyanın ötesinde toplumsal bir kırılma başlığına dönüşmüş durumda ⚖️. Bu yüzden sade anlatımda bile hem hukuk boyutu hem etik boyut hem de kamu vicdanı boyutu birlikte ele alınmalı; aksi halde tablo eksik kalıyor. İstersen bunu şimdi daha kısa, hızlı okunur 5 maddeye de ayırabilirim, ister misin?",
  "Bu konuyu anlatırken en güvenli yol; spekülasyondan uzak, ana eksenleri net vermek 🧭. Bir: ağır ve hassas suçlama başlıkları. İki: farklı dönemlerde gündeme gelen yargı süreçleri ve bunların kamuoyundaki yankısı. Üç: mağdur merkezli adalet beklentisinin giderek artması. Dört: güç ilişkileri nedeniyle dosyanın küresel görünürlük kazanması. Beş: olayın, kurumlara güven tartışmasını derinleştirmesi. Kısacası bu dosya yalnızca bir biyografi sorusu değil; sistemin nasıl çalıştığına dair bir stres testi gibi görüldü. Bu yüzden insanlar hâlâ bu başlığı konuşurken sadece geçmişi değil, bugün için çıkarılacak dersleri de tartışıyor 💬. İstersen aynı içeriği daha kompakt bir 5 maddelik kısa özet halinde de verebilirim, ister misin?",
  "Epstein olayının uzun anlatımında kritik nokta şu: konu, haber değeri olan tek bir olaydan ziyade zaman içinde büyüyen bir zincir etkisi oluşturdu 🌍. Hukuki adımlar, kamuoyu baskısı, medya görünürlüğü, mağdur ifadelerinin toplumsal etkisi ve güçlü çevrelerle ilgili tartışmalar birbirini besledi. Bu kombinasyon yüzünden dosya sadece adliye koridorlarında kalmadı; etik, hesap verebilirlik ve şeffaflık tartışmalarının merkezine taşındı. İnsanlar da bu nedenle 'kimdi?' sorusunun yanında 'neden bu kadar uzun süre gündemde kaldı?' sorusunu sormaya başladı. Kısacası olayın ağırlığı, yalnızca iddiaların niteliğinden değil, toplumun adalet algısına dokunmasından geliyor 🧠. İstersen bu uzun çerçeveyi pratik bir 5 maddeye indirip kolay okunur hâlde de yazabilirim, ister misin?",
  "Bu dosyayı kısa geçince genelde iki şey kayboluyor: mağdur perspektifi ve sistem eleştirisi 🧩. Oysa uzun çerçevede bakınca görüyoruz ki kamuoyu bu konuyu sadece bir kişi odaklı değil, kurumların refleksi ve adalet mekanizmasının güvenilirliği üzerinden tartıştı. Hukuki süreçlerin nasıl yürüdüğü, hangi kararların nasıl algılandığı, medyanın olayı nasıl taşıdığı ve toplumsal tepkinin nasıl büyüdüğü hep birlikte okununca tablo netleşiyor. Bu yüzden Epstein başlığı; modern dönemde güç, hukuk ve vicdan dengesinin tartışıldığı sembolik dosyalardan biri gibi görülüyor. Böyle anlatınca konu daha anlaşılır oluyor çünkü tek bir başlık yerine bütün sistemi etkileyen bir zincirden bahsediyoruz 🔎. İstersen bunu daha kısa 5 maddelik bir özet formatında da çıkartabilirim, ister misin?",
  "Uzun ve sade bir çerçeveyle söyleyeyim: bu başlığın bu kadar konuşulmasının nedeni yalnızca suçlama düzeyi değil; olayın etrafında oluşan geniş etki alanı. Hukuki süreçler kadar kamu güveni, mağdur görünürlüğü, etik hassasiyet ve kurumsal şeffaflık beklentisi de dosyanın parçası hâline geldi 📌. Dolayısıyla insanlar bu konuyu yalnızca kronoloji olarak değil, 'adalet nasıl görünmeli?', 'hesap verebilirlik nasıl sağlanmalı?' gibi daha büyük sorularla birlikte ele aldı. Bu yüzden dosya, zaman geçse de referans verilen bir tartışma başlığı olmayı sürdürdü. Yani özetle: tek bir olay değil, çok katmanlı bir toplumsal sınav gibi okundu. Eğer istersen bunun kısa versiyonunu 5 net maddeye bölüp hızlıca da paylaşabilirim, ister misin?",
  "Epstein konusunun neden karmaşık göründüğünü açık anlatayım 📝: çünkü burada aynı anda hukuk süreci, medya etkisi, toplumsal tepki ve mağdur odaklı adalet beklentisi çalışıyor. Bu katmanlar bir araya geldiğinde konu yalnızca 'kim ne yaptı?' düzeyinde kalmıyor; 'sistem bu gibi vakalarda ne kadar adil ve şeffaf?' sorusuna dönüşüyor. Kamuoyu ilgisinin uzun sürmesi de bundan: insanlar yalnızca bilgi değil, aynı zamanda hesap verebilirlik görmek istiyor. Bu yüzden bu dosya hem tarihsel hem etik bir örnek gibi anlatılıyor. Kısaca: başlık büyük çünkü etkilediği alan çok geniş 🔍. İstersen bunu şimdi daha pratik, kısa ve düzenli bir 5 madde formatına da çevirebilirim, ister misin?",
  "Bu konuya yaklaşırken ben sana dengeli ve spekülasyondan uzak bir çerçeve sunmak isterim 🤝. Genel tabloda gördüğümüz şey; ağır suçlama iddiaları, yıllara yayılan süreçler, mağdur anlatılarının etkisi ve yüksek görünürlük nedeniyle büyüyen toplumsal tartışma. Konu bu yüzden sadece bir adli vaka olarak değil, güç ilişkileri ve kurum güveni başlığında da ele alındı. İnsanların hâlâ bu dosyayı konuşmasının sebebi, olayın sadece geçmişte kalmaması; bugün için de 'adalet, şeffaflık ve koruma mekanizmaları' konusunda soru üretmesi. Dolayısıyla uzun anlatımda asıl değer, katmanları birlikte görmekte 📘. İstersen bu çerçeveyi 5 kısa maddeye indirgeyip hızlı okunur bir versiyon da hazırlayabilirim, ister misin?",
  "Epstein dosyası hakkında uzun ama sade özet şu olabilir: olayın etkisi, yalnızca iddiaların içeriğinden değil, toplumun buna verdiği tepkiden de büyüdü. Hukuki süreçler, medya görünürlüğü, mağdur odaklı adalet talebi ve güçlü çevreler hakkında oluşan soru işaretleri birlikte ilerledi. Bu birliktelik dosyayı küresel ölçekte tanınan bir tartışma alanına çevirdi 🌐. O yüzden bu başlık, tek haberlik bir konu değil; hukuk, etik ve kamu güveni kesişiminde duran bir örnek vaka olarak değerlendiriliyor. Böyle bakınca neden hâlâ gündemde kaldığı daha net görünüyor. İstersen şimdi bu uzun anlatımı kısa 5 maddelik bir özet formatına da dönüştürebilirim, ister misin?",
  "Bu meselede en kritik şey, anlatımı iki uca savurmamak: ne yüzeysel geçmek ne de doğrulanmamış iddialarla büyütmek ⚖️. Sağlıklı çerçevede; ciddi suçlama başlıkları, süreçlerin kamuoyundaki algısı, mağdurların görünürlüğü ve kurumsal güven tartışmaları birlikte ele alınır. Böyle baktığında Epstein konusu, yalnızca geçmişe dair bir olay olmaktan çıkıp modern adalet sistemine dair bir test gibi görünür. İnsanlar da bu nedenle konuya sadece merakla değil, adalet beklentisiyle yaklaşıyor. Uzun anlatımın amacı da tam olarak bu dengeyi kurmak: bilgi + bağlam + etki 🧠. İstersen bunu daha sade bir 5 madde özeti halinde de hemen çıkarayım, ister misin?",
  "Uzun açıklama isteyenler için net bir kapanış çerçevesi bırakayım: Epstein dosyası, adli içerik kadar toplumsal etki üreten bir başlık. Olayın büyük görünmesinin sebebi; mağdur odaklı adalet taleplerinin yükselmesi, süreçlerin çok tartışılması, medya baskısının artması ve kurumlara güvenin test edilmesi. Bu yüzden konuşma, bir kişiden çok bir sistem tartışmasına evrildi 🏛️. Yani mesele yalnızca 'kimdi?' değil, 'bu tip olaylarda toplum ne bekliyor ve kurumlar nasıl cevap veriyor?' sorusu. Böyle bakınca dosyanın neden bu kadar referans verildiği anlaşılır hâle geliyor. İstersen şimdi bunun kompakt 5 maddelik kısa özetini de çıkarabilirim, ister misin?"
];
...
function updateGeneralQuestionState(answer) {
  ...
  convoState.awaitingGeneralAnswer = answer.includes("?");
}
